...
import { captureApprovedCandidate } from "@/lib/services/memory-candidate-service";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const result = await captureApprovedCandidate(bridge.client, { id, userId: bridge.principal.userId, namespace: ns });
