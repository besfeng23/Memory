...
import { rejectCandidateForReview } from "@/lib/services/memory-candidate-service";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const result = await rejectCandidateForReview(bridge.client, { id, userId: bridge.principal.userId, namespace: ns, review_note: body.review_note, reason: body.reason });
