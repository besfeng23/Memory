...
export default async function OperatingProjectsPage({ searchParams }: Readonly<{ searchParams?: SearchParams }>) {
    ...
    return (
      <AppShell>
        <div className="page-stack">
          <PageHeader eyebrow="Phase 6B" title="Project Context Engine" description="Sign in to create durable project context." actions={<Link className="button-link button-link--primary" href="/auth/login">Login</Link>} />
        </div>
      </AppShell>
    );
  }
  ...
  return (
    <AppShell>
      <div className="page-stack">
        <PageHeader eyebrow="Phase 6B" title="Project Context Engine" description="Durable project memory for proof targets, tasks, decisions, constraints, artifacts, and open loops." actions={<Link className="button-link" href="/operating">Operating cockpit</Link>} />
