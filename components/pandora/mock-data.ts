...
export const fixtureDashboardData: PandoraDashboardData = { generatedAt: "No live data", operatorLabel: "Fixture", live: false, warnings: ["Mock only"], hero: { title: "Fixture dashboard", description: "Mock only: no live data.", primaryAction: "No live data", secondaryAction: "Semantic gated" }, evidence: "No live data", stats: [{ id: "fixture", title: "Fixture", value: "No live data", subtitle: "Mock only", color: "slate", sparklineData: [0, 0] }], memorySpaces, workQueue, profileSnapshot, timelineEvents, diagnostics: { coreSystems, gatedSystems, envelope: { title: "Fixture", description: "Mock only: no live data." } }, verification, shadowContextPackLab: { packs: [], warnings: [], countsByStatus: { draft: 0, ready_for_review: 0, reviewed: 0, rejected: 0, archived: 0 } }, promotionRequests: { requests: [], warnings: [], countsByStatus: { draft: 0, submitted: 0, approved: 0, blocked: 0, archived: 0 }, riskDistribution: { low: 0, medium: 0, high: 0, blocked: 0 } }, operatorActions: { actions: [], warnings: [], countsByStatus: { proposed: 0, dry_ran: 0, approved: 0, executing: 0, completed: 0, blocked: 0, failed: 0, cancelled: 0 } }, shadowPackPreflights: { preflights: [], warnings: [], countsByStatus: { draft: 0, ready_for_review: 0, reviewed: 0, approved_for_promotion: 0, blocked: 0, archived: 0 }, riskDistribution: { low: 0, medium: 0, high: 0, blocked: 0 } } };
